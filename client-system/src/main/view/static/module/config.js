layui.define(function (exports) {
    ...
    var config = {
        base_server: 'http://localhost:9300/', // 接口地址，实际项目请换成http形式的地址 http://106.13.3.200:80/	http://127.0.0.1:9200/
        eureka_server: 'http://localhost:9000/', // eureka注册中心地址				http://106.13.3.200:80/	http://127.0.0.1:9200/
